...
class Catalog2Controller extends Controller
{
    ...
    {
        $replicaUrl = 'http://localhost:8001/catalog/replicate-order'; // Adjust according to your environment
    ...
    {
        $replicaUrl = 'http://localhost:8001/catalog/replicate-update'; // Adjust according to your environment
